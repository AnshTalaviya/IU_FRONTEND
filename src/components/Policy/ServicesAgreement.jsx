      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="p-6 md:p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              <div className="border border-gray-700 p-4 rounded-lg">
                ...
                <div className="mt-2">
                  ...
                  <p className="text-gray-300">BCM Prime, 1st cross, BDA Layout, Guruppanan Palya, Tavarekere extension, Bannerghatta Road, Bangalore 560 041, Karnataka</p>
                </div>
                <p className="mt-2 text-gray-400 italic">
                  (hereinafter referred to as the "Idhar Udhar" / "We" / "Us" / "Our", which expression, if the context otherwise requires, shall mean and include its successors, assigns and Affiliates).
                </p>
              </div>
          ...
          <section className="mb-8 bg-gray-900 border-l-4 border-yellow-500 p-4">
            <p className="font-bold mb-2">PLEASE ENSURE THAT YOU READ AND UNDERSTAND ALL THE CLAUSES BEFORE YOU PROVIDE SERVICES TO Idhar Udhar, AS YOU SHALL BE BOUND BY ALL THE TERMS AND CONDITIONS CONTAINED HEREIN upon your Acceptance.</p>
            <p className="font-semibold">YOUR ACCEPTANCE / SHALL OPERATE AS A BINDING AGREEMENT BETWEEN YOU AND Idhar Udhar IN RESPECT OF THE VENDOR SERVICES TO Idhar Udhar.</p>
          </section>
          ...
          <section className="space-y-8">
            ...
            <div className="border-b border-gray-700 pb-6">
              ...
              <div className="space-y-4 text-gray-300">
                ...
                <p><span className="font-semibold">1.3.</span> Your Acceptance is a valid consent to be bound by this Agreement for using Idhar Udhar for the purpose of receiving and delivering the Vendor Services.</p>
                <p><span className="font-semibold">1.4.</span> Your engagement with Idhar Udhar to provide Vendor Services to Idhar Udhar is subject to your acceptance of the clauses, as specified in this Agreement. Idhar Udhar reserves the right to change, modify, add, or remove these clauses / terms and conditions, in part or in whole. It is your responsibility and duty to check the terms and conditions of Idhar Udhar periodically for the changes, if any. Your continued use of Idhar Udhar following the posting of changes will mean that You accept and agree to the changes, if any, made by Idhar Udhar.</p>
                <p><span className="font-semibold">1.5.</span> By accepting this Agreement, You further agree and consent to the collection, transfer, use, storage, disclosure and sharing of your information (personally identifiable or not), as per the applicable law(s). The data collected shall be utilised for improving Vendor Services to Idhar Udhar and in particular for the reason of internal record keeping, security and statutory disclosures, if any, as per the applicable law(s). You further agree to the Privacy Policy of Idhar Udhar as available on the website of Idhar Udhar</p>
              </div>
            </div>
            ...
            <div className="border-b border-gray-700 pb-6">
              ...
              <div className="space-y-4 text-gray-300">
                ...
                <p><span className="font-semibold">2.6.</span> You will have a functioning smartphone, active mobile number having the ability to read and send communication/message regarding the order/trip details including customer details, kms and time reading, amount paid by the customer and to convey to Idhar Udhar and/or Idhar Udhar verified agents.</p>
                <p><span className="font-semibold">2.7.</span> You will be a part of the standard vendor ratings process which will be dependent upon the transparent process and parameters of Idhar Udhar, failure to adhere with the rating process will have an impact on the Vendor Services and the decision / action consequent thereupon will be solely decided by Idhar Udhar;</p>
                ...
                <p><span className="font-semibold">2.10.</span> Pricing/trip fare, incentives & discounts provided to Customers of Idhar Udhar will be decided by Idhar Udhar at its sole and absolute discretion;</p>
                <p><span className="font-semibold">2.11.</span> You shall ensure and shall be solely responsible to ensure that before the pickup, the device / phone is available for Idhar Udhar for tracking and making the Vendor Services smooth. Your phone should not be busy for long, unavailable or switched off. Doing this, may lead to deductions in the amounts to be paid to You by adjusting the vendor pricing due to compensation paid to the customer, if any, given to the customer with the amount to be paid to You. Such deductions may extend up to any quantum of the amounts to be paid to You and would be decided at the sole and absolute discretion of Idhar Udhar;</p>
                <p><span className="font-semibold">2.12.</span> You shall be liable for all claim(s) and demand(s) raised by any third-party, at all times, in respect of the Vehicle (owned or hired). Idhar Udhar may or may not verify the details of the Vehicle used by You. In case of any claim(s), as to the title of the Vehicle between the registered owner of the Vehicle and You, Idhar Udhar shall not be held responsible for the same. You shall be liable to indemnify Idhar Udhar in case of the loss of it's brand value, goodwill, loss of business, direct or indirect claims, claims from accident and / or offenses under the Applicable Laws, etc. during the term of this Agreement and arising due to the direct or indirect acts of yours.</p>
                ...
                <p><span className="font-semibold">2.14.</span> You shall be liable to intimate to Idhar Udhar, within 24 hours, with regard to any disputes arising out of the Vendor Services and obligations and / or any legal expenses [including but not limited to charges incurred for releasing of seized Vehicle(s), advocate's fees and ancillary expenses] incurred by you while completing the trip, for no fault of yours. Idhar Udhar shall do all that is necessary to assist You to release the seized Vehicle(s) and safeguard your interests upon being intimated within the prescribed time period, as above, and upon internal investigation of the notified incident at Idhar Udhar end. In case of failure on your part to intimate Idhar Udhar within the specified time period, Idhar Udhar shall not be held liable and responsible for any costs, expenses and losses incurred by You in this behalf;</p>
                <p><span className="font-semibold">2.15.</span> You shall indemnify Idhar Udhar in accordance with the provisions of this Agreement;</p>
                ...
                <p><span className="font-semibold">2.17.</span> Any damage / loss / theft / misappropriation of consignment occurring during the rendering of the Vendor Services, on account of reasons attributable to Vendor, shall be completely indemnified by the Vendor to Idhar Udhar.</p>
              </div>
            </div>
            ...
            <div className="border-b border-gray-700 pb-6">
              ...
              <div className="space-y-4 text-gray-300">
                <p><span className="font-semibold">3.1.</span> The Agreement shall commence w.e.f. the Effective Date and shall be valid for a period of 1 (one) year unless terminated by Idhar Udhar.</p>
                ...
                <p><span className="font-semibold">3.3.</span> Idhar Udhar reserves the right to suspend or terminate this Agreement, at any point of time, without assigning any reason whatsoever or notice to the Service Provider.</p>
                <p><span className="font-semibold">3.4.</span> Termination of this Agreement shall be without prejudice to the acquired rights and obligations of Idhar Udhar existing on the date of termination (including any right to take action in respect of the circumstances giving rise to termination) and shall not affect any other rights and remedies available to Idhar Udhar.</p>
              </div>
            </div>
            ...
            <div className="border-b border-gray-700 pb-6">
              ...
              <div className="space-y-4 text-gray-300">
                <p><span className="font-semibold">4.1.</span> In consideration for performance of the Vendor Services, the Service Provider shall be entitled to receive Fees as notified by Idhar Udhar from time to time subject to deduction/collections of applicable Taxes.</p>
                <p><span className="font-semibold">4.2.</span> The applicable fees for the services shall be communicated to You on the application of Idhar Udhar prior to acceptance of the consignment which will be subject to variations (if any) including but not limited to changes in the route, any delay, etc during the performance of the services.</p>
                <p><span className="font-semibold">4.3.</span> All payments due to the Service Provider shall be made by a crossed pay order cheque in favor of Service Provider or through net banking / NEFT / RTGS etc., as decided by Idhar Udhar from time to time.</p>
                <p><span className="font-semibold">4.4.</span> The Service Provider acknowledges and agrees that in the event, any Tax proceedings are initiated against Idhar Udhar, the Service Provider shall fully cooperate with Idhar Udhar by furnishing the relevant information related to the supply provided to Idhar Udhar on a timely basis as may be required by Idhar Udhar. Furthermore, all the damages and other costs incurred by Idhar Udhar due to any fault of the Service Provider, the Service Provider shall indemnify Idhar Udhar for all such damages and other costs.</p>
                <p><span className="font-semibold">4.5.</span> The Fees payable to the Service Provider is inclusive of all applicable central, state, and other Taxes and levies applicable in the hands of the Service Provider. Further, Idhar Udhar shall withhold applicable income tax on the payments being made to the Service Provider.</p>
                <p><span className="font-semibold">4.6.</span> The Service Provider shall be solely responsible to pay the Taxes or any other applicable taxes with respect to the provision of Vendor Services provided to Idhar Udhar.</p>
                <p><span className="font-semibold">4.7.</span> In case of cash bookings, You shall collect on behalf of Idhar Udhar, the transportation with customer (as displayed on the application of Idhar Udhar or if otherwise agreed upon by Idhar Udhar and the You at the time of accepting the said booking), parking charges, additional night surcharge (where applicable) and any fee or levy presently payable or hereinafter imposed by Applicable Law(s) or required to be paid for the Service.</p>
                <p><span className="font-semibold">4.8.</span> Toll charges will be payable by the customer (whether by way of cash or credit, as previously agreed between Idhar Udhar and the Customer as applicable, when the Vehicle that is in use and crosses a toll post.</p>
              </div>
            </div>
            ...
            <div className="border-b border-gray-700 pb-6">
              ...
              <div className="space-y-4 text-gray-300">
                <p><span className="font-semibold">5.1.</span> The relationship between You and Idhar Udhar is that of independent contractors and on a principal-to-principal basis. Nothing in this Agreement shall be construed as creating a partnership, joint venture, employer-employee, agency, or other relationship between the Parties.</p>
                <p><span className="font-semibold">5.2.</span> You covenant that all Persons assigned by You (not by way of transfer) to perform Vendor Services under this Agreement shall be your employees or contractors and under no circumstances shall such Persons be deemed to be employees / workers of Idhar Udhar.</p>
              </div>
            </div>
            ...
            <div className="space-y-6 text-gray-300">
              <div>
                ...
                <div className="mt-4 space-y-3">
                  <p><span className="font-semibold">"Acceptance"</span> means your affirmative action of, (i) clicking on the box against the words "I Accept / Agree" or (ii) by "logging-in" / "signing-in" on the application of Idhar Udhar, provided at the end of this Agreement (including its annexure and the General Terms and Conditions), by which action, You unequivocally accept and agree to the Agreement and any modifications thereof;</p>
                  <p><span className="font-semibold">"Affiliates"</span> means any corporation, association, or other entity that directly or indirectly owns, is owned by, or is under common ownership with the Idhar Udhar, either currently or during subsistence of this Agreement.</p>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <p>Idhar Udhar does neither warrant that You will be able to use Idhar Udhar's application and / or will be able to provide the Vendor Services at all times or locations on Idhar Udhar nor it warrants that Idhar Udhar will be uninterrupted or error-free or that the defects will be capable of being corrected by Idhar Udhar in a timely fashion. The Services, Devices, the output generated there from, and all other technology developed by Idhar Udhar are provided to you on an "AS IS" and "AS AVAILABLE" basis and Idhar Udhar specifically disclaims all warranties and indemnities, express, implied or statutory, including without limitation any warranty of merchantability, fitness for a particular purpose, accuracy, completeness, any assurance of minimum business guarantee with respect to any Fees or any other warranty arising from the course of performance or course of dealing.</p>
                  <p>Idhar Udhar shall not be responsible or liable for any loss or damage, how so ever caused or suffered by the Service Provider arising out of the use of the service offered by Idhar Udhar or due to the failure of Idhar Udhar to provide services to the consignor/consignee for any reason whatsoever including but not limited to any customer's noncompliance with the services offered by Idhar Udhar, which includes, but is not limited to any incorrectly placed voice instructions, malfunction, partial or total failure of any network terminal, data processing system, computer tele transmission or telecommunication system or other circumstances whether or not beyond the control of Idhar Udhar or any person or any organization involved in the above mentioned systems. The Service provider shall also be liable to Idhar Udhar for any loss caused to Idhar Udhar due to the negligence of the Service Provider and/or his appointed operators/contractors and or any unlawful act or omission in the performance of the Vendor Services. Without prejudice to the above, Idhar Udhar shall not be liable for any direct or indirect loss or damage, which may be suffered by the Service Provider as a result of any failure by a consignor/consignee to show up within any stipulated time even if Idhar Udhar has agreed to such timing or even if the customer has advised Idhar Udhar of the possibility that he/she may not show up within the stipulated time; Idhar Udhar makes available general third-party information and other data from external sources ("Third Party Content"). The provision of Third-Party Content is for general informational purposes only. The Service Provider acknowledges that the Third-Party Content provided is obtained from sources believed to be reliable. Idhar Udhar does not provide any guarantee with respect to any Third-Party Content and Idhar Udhar shall not be held liable for any loss suffered by the Service Provider based on the reliance placed on or use of Third-Party Content. Further, to the extent that such Third-Party Content is infringing upon some other party's intellectual property rights or proprietary rights, Idhar Udhar shall not be held liable for the same at any instances.</p>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <p>You shall indemnify Idhar Udhar R from and against and in respect of any or all liabilities, losses, charges and expenses (including legal fees and costs on a full indemnity basis) claims in general and any provision which forms a part of this Agreement, demands, actions and proceedings, which Idhar Udhar may incur or sustain directly or indirectly from any breach by You of your obligations hereunder or any breach of your representations and warranties, or by any reason, or in real action to the provision or proposed provision of the Vendor Services and You shall forthwith pay all such sums forthwith on demand by Idhar Udhar in writing.</p>
                  <p>Notwithstanding any other provisions of this Agreement, You shall be liable to Idhar Udhar for indirect, special, or consequential damages arising out of or in connection with the provision of Vendor Services under this Agreement.</p>
                  <p>You agree that except for the reasons of Force Majeure, in the event of any loss or damage to Idhar Udhar that arises from the Vendor Services, You shall make good the loss, costs, charges, and expenses that Idhar Udhar may suffer or incur.</p>
                  <p>To the extent permissible under Applicable Laws, Idhar Udhar is not liable for any civil, criminal, tortious, or any other liability, that may accrue as a consequence of your breach (a) of the Applicable Laws while providing Vendor Services to Idhar Udhar; (b) of the terms of the applicable licenses and permits of the Vehicle(s) that are issued by the transport authorities; (c) of the terms of this Agreement.</p>
                  <p>Idhar Udhar's maximum liability to You in any event, which includes any failure by Idhar Udhar under this Agreement, shall be restricted and limited to a maximum amount of INR 500 (Indian Rupees Fiver Hundred Only) in the aggregate during the Term.</p>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <ol className="list-decimal pl-6 space-y-2">
                    <li>Except as expressly set forth herein, as between the Parties, Idhar Udhar shall remain the owner of all intellectual property that it owns or controls as of the Effective Date or that it develops or acquires thereafter. Nothing in this Agreement will function to transfer any of either Party's intellectual property rights to the other Party and each Party will retain exclusive interest in and ownership of its intellectual property developed before this Agreement or developed outside the scope of this Agreement.</li>
                    <li>Any intellectual property rights created during the course of the Agreement shall be exclusively owned by Idhar Udhar.</li>
                    <li>All Intellectual Property Rights in relation to the branding/advertisement shall continue with Idhar Udhar. No part of this clause or this Agreement shall imply any license/assignment of the Intellectual Property Rights by Idhar Udhar to the Service Provider in respect of the Idhar Udhar logo.</li>
                  </ol>
                </div>
              </div>
            </div>
          ...
          <div className="mb-12">
            ...
            <div className="space-y-6 text-gray-300">
              ...
              <div>
                ...
                <div className="space-y-4">
                  ...
                  <ol className="list-disc pl-6 space-y-2">
                    ...
                    <li>Possess valid driving licenses and registration (copies to be shared with Idhar Udhar).</li>
                  </ol>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <p><span className="font-semibold">6.1.</span> The Fees for 2W Vendor Services shall be as per the rates specified by Idhar Udhar from time to time, which may vary based on:</p>
                  <ol className="list-decimal pl-6 space-y-2">
              ...
              <div>
                ...
                <div className="space-y-4">
                  <p><span className="font-semibold">7.1.</span> Service Provider shall not commit any fraud while providing Vendor Services. Idhar Udhar reserves the right to:</p>
                  <ol className="list-disc pl-6 space-y-2">
              ...
              <div>
                ...
                <div className="space-y-4">
                  ...
                  <p><span className="font-semibold">8.2.</span> Idhar Udhar may, on a best-effort basis, reimburse limited legal expenses (max ₹5,000) subject to internal verification.</p>
                </div>
              </div>
            ...
            <div className="space-y-6 text-gray-300">
              ...
              <div>
                ...
                <div className="space-y-4">
                  ...
                  <ol className="list-decimal pl-6 space-y-2">
                    ...
                    <li>Be in good working condition with all necessary safety features;</li>
                    <li>Have a valid pollution under control (PUC) certificate;</li>
                    <li>Have adequate space for goods transportation as per Idhar Udhar specifications;</li>
                    <li>Be equipped with rope, ply, and hooks for efficient service;</li>
                    <li>For 4W: Have functioning GPS device (if required by Idhar Udhar).</li>
                  </ol>
              ...
              <div>
                ...
                <div className="space-y-4">
                  ...
                  <ol className="list-decimal pl-6 space-y-2">
                    ...
                    <li>Conduct services with honesty and discipline per Idhar Udhar policies;</li>
              ...
              <div>
                ...
                <div className="space-y-4">
                  ...
                  <ol className="list-disc pl-6 space-y-2">
                    ...
                    <li>Damage Idhar Udhar's reputation/assets;</li>
              ...
              <div>
                ...
                <div className="space-y-4">
                  ...
                  <p><span className="font-semibold">8.2.</span> Idhar Udhar may reimburse limited legal expenses (max ₹10,000) subject to:</p>
                  <ol className="list-disc pl-6 space-y-2">
              ...
              <div>
                ...
                <div className="space-y-4">
                  <p><span className="font-semibold">9.1.</span> Idhar Udhar may terminate for:</p>
                  <ol className="list-disc pl-6 space-y-2">
          ...
          <div className="mb-12 space-y-8">
            ...
            <div className="border border-gray-200 rounded-lg p-6">
              ...
              <div className="mb-6">
                ...
                <table className="w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr className="border-b border-gray-200">
                      <td className="py-2">Contact Number (Idhar Udhar)</td>
                      <td className="py-2"><span className="text-gray-400">[To be filled]</span></td>
                    </tr>
                    <tr className="border-b border-gray-200">
              ...
              <div className="mt-8 p-4 border-t-2 border-gray-200">
                <p className="text-sm italic">For & on behalf of the Service Provider, I declare that the above information is correct. Any changes will be duly informed to Idhar Udhar in advance.</p>
              </div>
            </div>
            ...
            <div className="border border-gray-200 rounded-lg p-6 mt-8">
              ...
              <div className="space-y-4">
                ...
                <ol className="list-decimal pl-5 space-y-2">
                  <li>Engage my Vehicle under the Service Agreement with Idhar Udhar;</li>
                  <li>Collect all payments/compensation for services rendered;</li>
                </ol>
                <p>I confirm no objection to any commercial transactions between the Service Provider and Idhar Udhar involving my Vehicle.</p>
                <div className="mt-8">
                  <p>Thanking You,</p>
                  <div className="mt-6">
