...
export default function HomeSections() {
  return (
    <div>
      ...
      <section className="bg-gray-900 text-white py-20 px-6  rounded-xl max-w-6xl mx-auto">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-16 text-green-400">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          {[ 
            ...
            <motion.div
              ...
              className="group flex flex-col items-center text-center relative bg-gray-800 p-6 rounded-xl transition-colors duration-300 hover:bg-gray-700 w-full md:w-72 min-h-[250px]"
            >
