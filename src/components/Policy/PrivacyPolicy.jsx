            ...
            <div className="max-w-4xl mx-auto space-y-6">
                ...
                <div className="p-6">
                    ...
                    <div className="text-white space-y-3">
                        ...
                        <p>
                            The terms “you” and “your” refer to the user of the <strong>Idhar Udhar</strong> Apps. The term “Services” refers to any services offered by <strong>Idhar Udhar</strong> whether on the <strong>Idhar Udhar</strong> Apps or otherwise. This Policy is a part of and incorporated within, and is to be read along with, the applicable Terms of Service and the Driver Partner Terms and Conditions based on the user of <strong>Idhar Udhar</strong>.
                        </p>
                        <p>
