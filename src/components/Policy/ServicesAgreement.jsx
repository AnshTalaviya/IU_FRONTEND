        ...
        <div className="p-6 md:p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              <div className="border border-gray-700 p-4 rounded-lg">
                ...
                <p className="mt-2 text-gray-400 italic">
                  (hereinafter referred to as the <strong>"<strong>Idhar Udhar</strong>"</strong> / "We" / "Us" / "Our", which expression, if the context otherwise requires, shall mean and include its successors, assigns and Affiliates).
                </p>
              </div>
          ...
          <section className="mb-8 border-b border-gray-700 pb-6">
            ...
            <div className="space-y-4">
              ...
              <ol className="list-decimal pl-6 space-y-2 text-gray-300">
                <li>
                 <strong><strong>Idhar Udhar</strong></strong> is an on-demand logistics' services provider engaged in the business of transportation of goods of its customers from one place to the another, under the brand name of <strong><strong>Idhar Udhar</strong></strong>; and
                </li>
                <li>
                 <strong><strong>Idhar Udhar</strong></strong> avails services of drivers/ service provider in the course of its regular business
                </li>
                <li>
                  Service Provider is an individual / entity who is an independent commercial Vehicle operator and / or driver, who agrees to provide services of renting/ hiring of motor vehicle, with operator to <strong><strong>Idhar Udhar</strong></strong>, and has agreed to make himself available for the services of <strong><strong>Idhar Udhar</strong></strong> for the purposes as stated herein based on the terms and conditions attached with this Agreement.
                </li>
              </ol>
            </div>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="mt-4 text-gray-300">
              Reference to this Agreement shall include the applicable above documents and the General Terms and Conditions of<strong><strong>Idhar Udhar</strong></strong>.
            </p>
                    </td>
                  </tr>
                </tbody>
              ...
              (The Service Provider and <strong><strong>Idhar Udhar</strong></strong> are hereinafter collectively referred to as the "Parties" and individually each as a "Party" and the word Service Provider and You, shall include its driver(s), as well).
            </p>
            </div>
          </section>
          ...
          <section className="mb-8 bg-gray-900 border-l-4 border-yellow-500 p-4">
            <p className="font-bold mb-2">PLEASE ENSURE THAT YOU READ AND UNDERSTAND ALL THE CLAUSES BEFORE YOU PROVIDE SERVICES TO<strong><strong>Idhar Udhar</strong></strong>, AS YOU SHALL BE BOUND BY ALL THE TERMS AND CONDITIONS CONTAINED HEREIN upon your Acceptance.</p>
            <p className="font-semibold">YOUR ACCEPTANCE / SHALL OPERATE AS A BINDING AGREEMENT BETWEEN YOU AND <strong><strong>Idhar Udhar</strong></strong> IN RESPECT OF THE VENDOR SERVICES TO <strong><strong>Idhar Udhar</strong></strong>.</p>
          </section>
          ...
          <section className="space-y-8">
            ...
            <div className="border-b border-gray-700 pb-6">
              ...
              <div className="space-y-4 text-gray-300">
                ...
                <p><span className="font-semibold">1.3.</span> Your Acceptance is a valid consent to be bound by this Agreement for using <strong><strong>Idhar Udhar</strong></strong> for the purpose of receiving and delivering the Vendor Services.</p>
                <p><span className="font-semibold">1.4.</span> Your engagement with <strong><strong>Idhar Udhar</strong></strong> to provide Vendor Services to <strong>Idhar Udhar</strong> is subject to your acceptance of the clauses, as specified in this Agreement. <strong><strong>Idhar Udhar</strong></strong> reserves the right to change, modify, add, or remove these clauses / terms and conditions, in part or in whole. It is your responsibility and duty to check the terms and conditions of <strong><strong>Idhar Udhar</strong></strong> periodically for the changes, if any. Your continued use of <strong><strong>Idhar Udhar</strong></strong> following the posting of changes will mean that You accept and agree to the changes, if any, made by <strong><strong>Idhar Udhar</strong></strong>.</p>
                <p><span className="font-semibold">1.5.</span> By accepting this Agreement, You further agree and consent to the collection, transfer, use, storage, disclosure and sharing of your information (personally identifiable or not), as per the applicable law(s). The data collected shall be utilised for improving Vendor Services to <strong><strong>Idhar Udhar</strong></strong> and in particular for the reason of internal record keeping, security and statutory disclosures, if any, as per the applicable law(s). You further agree to the Privacy Policy of <strong><strong>Idhar Udhar</strong></strong> as available on the website of <strong><strong>Idhar Udhar</strong></strong></p>
              </div>
            </div>
            ...
            <div className="border-b border-gray-700 pb-6">
              ...
              <div className="space-y-4 text-gray-300">
                <p><span className="font-semibold">2.1.</span> You shall not have more than one active <strong><strong>Idhar Udhar</strong></strong> vendor registration which you are further prohibited from selling, trading, or otherwise transferring to another party;</p>
                <p><span className="font-semibold">2.2.</span> Service Provider/ Driver Information shall be true and correct and there will be no information that could impact your performance to render Vendor Services pursuant to this Agreement, shall be hidden from <strong><strong>Idhar Udhar</strong></strong> at any point of time. In case of furnishing of inaccurate data, <strong><strong>Idhar Udhar</strong></strong> reserves the right to deregister and/or suspend/terminate and/or take appropriate legal proceedings against the Vendor without prior notice.;</p>
                ...
                <p><span className="font-semibold">2.4.</span> You shall not use any, information pertaining to the <strong><strong>Idhar Udhar</strong></strong> customer, including, but not limited thereto any confidential information, according to and available with <strong><strong>Idhar Udhar</strong></strong>, for any purpose other than perform your obligations under or in connection with this Agreement;</p>
                ...
                <p><span className="font-semibold">2.6.</span> You will have a functioning smartphone, active mobile number having the ability to read and send communication/message regarding the order/trip details including customer details, kms and time reading, amount paid by the customer and to convey to <strong><strong>Idhar Udhar</strong></strong> and/or <strong><strong>Idhar Udhar</strong></strong> verified agents.</p>
                <p><span className="font-semibold">2.7.</span> You will be a part of the standard vendor ratings process which will be dependent upon the transparent process and parameters of <strong><strong>Idhar Udhar</strong></strong>, failure to adhere with the rating process will have an impact on the Vendor Services and the decision / action consequent thereupon will be solely decided by <strong><strong>Idhar Udhar</strong></strong>;</p>
                ...
                <p><span className="font-semibold">2.10.</span> Pricing/trip fare, incentives & discounts provided to Customers of <strong><strong>Idhar Udhar</strong></strong> will be decided by <strong><strong>Idhar Udhar</strong></strong> at its sole and absolute discretion;</p>
                <p><span className="font-semibold">2.11.</span> You shall ensure and shall be solely responsible to ensure that before the pickup, the device / phone is available for <strong><strong>Idhar Udhar</strong></strong> for tracking and making the Vendor Services smooth. Your phone should not be busy for long, unavailable or switched off. Doing this, may lead to deductions in the amounts to be paid to You by adjusting the vendor pricing due to compensation paid to the customer, if any, given to the customer with the amount to be paid to You. Such deductions may extend up to any quantum of the amounts to be paid to You and would be decided at the sole and absolute discretion of <strong><strong>Idhar Udhar</strong></strong>;</p>
            ...
            <div className="space-y-6 text-gray-300">
              <div>
                ...
                <div className="mt-4 space-y-3">
                  ...
                  <p><span className="font-semibold">"Fees"</span> means the consideration payable by <strong>Idhar Udhar</strong> to the Vendor/ Driver for providing the Vendor Services;</p>
                  ...
                  <p><span className="font-semibold">"General Terms and Conditions"</span> or "Vendor/ Driver T&C" or "Terms and Conditions" refers to the Vendor/ Driver Terms and Conditions, which are forming part of this Agreement under Annexure B and/or C and are also available on the website and application of <strong>Idhar Udhar</strong>, as may be amended by <strong>Idhar Udhar</strong> from time to time;</p>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <ol className="list-decimal pl-6 space-y-2">
                    ...
                    <li>Vendor/ Driver as Service Provider hereby agree that their documents may be sent for background verification ("BGV") by <strong>Idhar Udhar</strong> and if there is any discrepancy / issue in the opinion of <strong>Idhar Udhar</strong>, found during or post BGV, this Agreement shall stand null and void with immediate effect at the sole discretion of <strong>Idhar Udhar</strong>.</li>
                    <li>The Service Provider further acknowledges and agrees that:
                      <ol className="list-decimal pl-6 space-y-2">
                        <li><strong>Idhar Udhar</strong> neither owns or in any way controls the Vehicles used by the Service Provider rendering the Vendor Services to <strong>Idhar Udhar</strong>, nor it controls the action(s) of the Service Provider providing the Vendor Services to <strong>Idhar Udhar</strong>, in case the Service Provider itself is not the Driver.</li>
