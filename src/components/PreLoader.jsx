    ...
    <div className="relative w-full h-screen bg-black overflow-hidden flex items-center justify-center">
      ...
      {showText && (
        <div className="absolute z-30 bottom-[40%] flex flex-col items-center justify-center md:flex-row md:space-x-4">
          ...
          <h1 className="text-white text-5xl md:text-6xl font-black animate-idhar-appear mt-4 md:mt-0">
            Idhar<span className="text-green-400">Udhar</span>
          </h1>
        </div>
      )}
    </div>
