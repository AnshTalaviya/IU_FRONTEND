...
<div className="space-y-4">
        ...
        <>
          ...
          {totalPages > 1 && (
            <div className="flex justify-between items-center pt-4">
              <button
                className={`dark:bg-gray-700 bg-gray-200 hover:dark:bg-gray-600 hover:bg-gray-300 text-white px-4 py-2 rounded-lg transition-colors text-sm ${
  ...
  <div className={`text-sm ${saveStatus.vehicle.isError ? 'text-red-500' : 'text-green-500'} animate-fadeIn`}>
    ...
    onClick={cancelLogout} // Close when clicking outside
  >
                 <div 
      className="dark:bg-gray-800 bg-white rounded-xl dark:border-gray-700 border-gray-300 p-6 max-w-md w-full shadow-xl"
